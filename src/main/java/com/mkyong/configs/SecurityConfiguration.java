...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(JwtAuthenticationFilter jwtAuthenticationFilter_, AuthenticationProvider authenticationProvider_) {
...
//        }));
        ...
        http.authorizeHttpRequests(auth -> auth.requestMatchers("/auth/**").permitAll().requestMatchers("/users/all").permitAll()
